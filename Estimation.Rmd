...
port_data_agg <- merge(port_data_agg, terminal_number, by.x = c("port_code"), by.y = c("port_code"), all.x = T) 
...
results_gt <- gt(results, rowname_col = "Estimate") |>
              ...
              sub_missing(columns = everything(),
                          rows = everything(),
                          missing_text = "") |>
              tab_footnote(footnote = "Stars indicate that the uniform confidence interval does not include zero.") |>
