...
results <- merge(results, ny_results, by=c("Estimate","measure"),  suffixes = c(".nt", ".nyt"))
...
ggplot(graph_results, aes(x = period, y = att/1000)) + 
  ...
  labs(x = "Period", y = "ATT (mil. TEU)", caption = "Footnote: Confidence interval is based on analytical standard errors.") +
  theme_minimal() +
