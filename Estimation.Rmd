...
spec1 <- feols(container ~ ownership_china | port_code + period,
               data = port_data_agg)
spec2 <- feols(container ~ ownership_china | port + sender + period,
               data = port_data)
spec3 <- feols(container ~ ownership_china| port^sender + period,
               data = port_data)
spec4 <- feols(container ~ ownership_china| port^sender + sender^period,
               data = port_data)
