...
```{r include=FALSE, warning=FALSE, message=FALSE}
# include Sea dummies: Mediterranean Sea (47), Atlantic Ocean (34), North Sea (37), Baltic Sea (19), Black Sea (3)
...
print(med_sea_ports)
### 47 of our ports are in the greater space of the Mediterranean Sea and 93 are not, total ports = 140, therefore 1/3 of the sample ports are in the Mediterranean.
...
atlantic_ports <- c("Bilbao", "Gijon", "Huelva", "Las Palmas", 
                    ...
                    "Southampton", "Warrenpoint", "Drogheda", 
...
### 34 ports are in the Atlantic Ocean or connect to it.
