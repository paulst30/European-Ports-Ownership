...
plot5 <- ggplot() +
  geom_line(data = Gdansk_CN_in, aes(x = period, y = container/1000, linetype = "Inflow")) +
...
plot9 <- ggplot() +
  geom_line(data = Klaipeda_all_in, aes(x = period, y = container/1000, linetype = "Inflow")) +
  geom_line(data = Klaipeda_all_out, aes(x = period, y = container/1000, linetype = "Outflow")) +
  geom_vline(xintercept = 100, color = "black") + ggtitle("Container flows between Klaipeda and all partners")+ theme_minimal() + 
  theme(text = element_text(size=10, family="LM Roman 10"),
...
plot10 <- ggplot() +
  geom_area(data = Klaipeda_major_partners, aes(x = period, y = container/1000,  fill = partner), position = "stack") +
  geom_vline(xintercept = 100, color = "black") + 
  #ggtitle("Container flows between Klaipeda and important partners")+ 
  theme_minimal() + 
  xlab("Period") +
  ylab("TEU (thousands)") +
...
# arrange second plot
policytool_plots1 <- plot10
#policytool_plots1 <- plot_grid(plot9, plot10, ncol = 2, nrow = 1, align = "h")
