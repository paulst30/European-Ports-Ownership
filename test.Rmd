...
results2 <- data.frame(Estimate = c("simple average", port_list$port[match(as.character(attgt_cond_ny$groupwise_treatment_effects$id), port_list$id)]),
...
results2 <- results[c("Estimate", "ATT", "Conf")]
...
latex_code <- print.xtable(xtable(results_final, caption = "ATreatment effects on the extensive and intensive margins"),
